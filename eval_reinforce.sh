...
python -m poker.play  --num_H_players 0 --num_D_validation_players 3 --num_D_primary_players 1 --primary_state_dict R1.st
python -m poker.play  --num_H_players 0 --num_D_validation_players 2 --num_D_primary_players 2 --primary_state_dict R1.st
